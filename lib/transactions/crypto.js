...
function getExchangeBytes(asset) {
  ...
  try {
    ...
    //bignum update bb.writeInt64(asset.price);
...
function getBytes(transaction, skipSignature, skipSecondSignature) {
  ...
  // +8
//bignum update  bb.writeLong(transaction.amount);
